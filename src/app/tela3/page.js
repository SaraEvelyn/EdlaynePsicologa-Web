  ...
  return (
    <div id="tela-inicial">
      ...
      <div id="welcome-message">
        <p className="bemVindo">Bem vindo Evilayne </p>
        <p className="teLo">é um prazer tê-lo(a) aqui!</p>
        <p className="ofereco">
          Ofereço um ambiente seguro e compassivo, promovendo o<br /> bem-estar
          emocional através da psicologia. Com ética e<br /> compaixão, estou aqui
          para apoiá-lo em sua jornada de
          <br /> crescimento pessoal. Bem-vindo ao meu espaço de apoio e <br />
          desenvolvimento.
        </p>
      </div>
    </div>
